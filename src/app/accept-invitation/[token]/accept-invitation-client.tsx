...
export function AcceptInvitationClient({
      ...
      <div className="w-full max-w-md">
        <div className="rounded-[24px] border border-[#e8e4db] bg-white shadow-sm">
          <div className="rounded-t-[24px] border-b border-[#e8e4db] bg-[#1a1a18] px-8 py-7">
            ...
            <h1 className="mt-4 text-xl font-semibold leading-snug text-[#faf9f7]">
              {companyName}
            </h1>
          </div>
  ...
  if (isExpired) {
    return card(
      <div className="space-y-4 text-center">
        <div className="text-3xl">Expired</div>
  ...
  return card(
    <div className="space-y-5">
      ...
      <div className="space-y-1.5 rounded-[12px] bg-[#f8f7f3] px-5 py-4 text-sm">
      ...
      <p className="text-center text-[12px] leading-relaxed text-[#9b9488]">
