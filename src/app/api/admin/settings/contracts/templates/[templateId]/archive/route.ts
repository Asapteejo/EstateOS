...
import { archiveContractTemplateVersion } from "@/modules/contracts/service";
import {
...
export async function POST(
  ...
  try {
    return ok(await archiveContractTemplateVersion({
    ...
    return fail(error instanceof Error ? error.message : "Unable to archive contract template.", 400);
  }
}
