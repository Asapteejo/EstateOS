...
function buildDemoBoard(): DealBoardData {
  return {
    summary: {
      totalDeals: 6,
    ...
    recentEvents: [
      {
        id: "demo-event",
        title: "Demo workspace waiting",
        detail: "Load a realistic sample workspace or add one property and one buyer to make the board useful.",
        createdAt: "Now",
      },
    ],
  };
