  ...
  return (
    <span className={cn("relative inline-flex", className)}>
      <select
        ...
        className="admin-interactive admin-focus h-11 w-full cursor-pointer appearance-none rounded-[var(--radius-md)] border border-[var(--line)] bg-white pl-4 pr-10 text-base text-[var(--ink-900)] focus:border-[var(--brand-500)] disabled:cursor-not-allowed disabled:bg-[var(--sand-50)] disabled:text-[var(--ink-500)] sm:text-sm"
        {...props}
      >
        {children}
      </select>
